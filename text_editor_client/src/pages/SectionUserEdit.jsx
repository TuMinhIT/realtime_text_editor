...
const SectionUserEdit = () => {
  ...
  const handleInsertProofTable = async () => {
    ...
    if (!editor) {
      toast.warning("Không tìm thấy trình soạn thảo văn bản.");
      return;
    }
    try {
  ...
  return (
    <SectionContext.Provider
      value={{ selectedSection, editorRef, handleInsertProofTable }}
    >
              ...
              <div className="border-b border-slate-200 px-4 py-4">
                <div className="grid grid-cols-2 gap-2 rounded-2xl bg-slate-100 p-1">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 rounded-xl px-3 py-2 text-sm font-semibold transition ${tab === "section"
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 rounded-xl px-3 py-2 text-sm font-semibold transition ${tab === "proofFile"
                      ? "bg-white text-[#1a73e8] shadow-sm"
                      : "text-slate-600 hover:bg-white/70 hover:text-slate-900"
                      }`}
                  >
                    ...
                    if (section.level == 1)
                      ...
                      return (
                        <button
                          ...
                          className={`w-full border-b  px-2 py-2 text-left transition ${isSelected
